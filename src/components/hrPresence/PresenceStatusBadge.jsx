...
const presenceStatusClasses = {
  ...
  Mapped: "border-sky-200 bg-sky-50 text-sky-700",
  ...
  "Fingerprint File": "border-emerald-200 bg-emerald-50 text-emerald-700",
  "Fingerprint Sync": "border-emerald-200 bg-emerald-50 text-emerald-700",
  "Face Recognition": "border-violet-200 bg-violet-50 text-violet-700",
  "Employee Not Mapped": "border-sky-200 bg-sky-50 text-sky-700",
  "Duplicate Scan": "border-amber-200 bg-amber-50 text-amber-700",
  "Invalid Datetime": "border-rose-200 bg-rose-50 text-rose-700",
  "Missing Pair": "border-orange-200 bg-orange-50 text-orange-700",
  "Ambiguous Direction": "border-violet-200 bg-violet-50 text-violet-700",
  "Out Of Shift Range": "border-slate-200 bg-slate-100 text-slate-700",
  "Device Unknown": "border-slate-200 bg-slate-100 text-slate-700",
  "Location Invalid": "border-rose-200 bg-rose-50 text-rose-700",
};
