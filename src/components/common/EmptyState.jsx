    ...
    <div className="rounded-3xl border border-dashed border-[var(--border-strong)] bg-[linear-gradient(180deg,rgba(248,250,252,0.92),rgba(241,245,249,0.74))] p-8 text-center">
      ...
      {actionLabel ? (
        <button
          type="button"
          onClick={onAction}
          className="mt-4 inline-flex rounded-full border border-[var(--border-soft)] bg-white px-4 py-2 text-sm font-medium text-[var(--text-main)] shadow-sm transition hover:bg-[var(--surface-0)]"
        >
          {actionLabel}
        </button>
      ) : null}
