...
export const sidebarSections = [
  ...
  },
  {
    ...
    hiddenIfEmpty: false,
    items: [{ key: "hr-presensi-dashboard", route: "/hr-presensi/dashboard", label: "HR Presensi", icon: ClipboardList, roles: [appRoles.hr, appRoles.owner, appRoles.supervisor], enabled: true }],
  },
  {
    key: "hr-payroll",
    title: "HR Payroll",
