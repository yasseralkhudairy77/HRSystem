...
export const attendanceSettings: AttendanceSettings[] = [
  {
    ...
    max_checkin_distance_minutes: 180,
    max_checkout_distance_minutes: 240,
    allow_unmatched_logs: false,
    auto_process_imported_logs: true,
    require_employee_mapping_before_processing: true,
    default_direction_mode: "heuristic",
    mobile_location_validation_enabled: true,
    mobile_selfie_validation_enabled: true,
